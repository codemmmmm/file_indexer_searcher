...
The service will use my dockerhub image mmdockermmmm/indexer_ubuntu which requires the config file to be created by the install script using the native installation option.
